...
class Admin_ProductsController extends Zend_Controller_Action
{
        ...
        if($request->getParam('Speichern')){
            ...
            if($id){
                ...
                if($product){
                    ...
                    $typeGroups = Model_ProductGroup::getByType($group->type);
                    $groupElements = array();
    ...
    public function picturesAction(){
        ...
        if($_FILES){
            ...
            $ret = '<tr><td><input type="checkbox" name="imagesDelete[]" value="" /></td><td><img style="width:120px;" src="/img/products/174px_sqr/' . htmlspecialchars($filename) . '" alt=""></td></tr>';
